  ...
  return (
    <>
      ...
      <div>
        ...
        {/* search category */}
        <div className='flex justify-left items-center mt-10 ml-10'>
          <div className='flex items-center relative'>
            ...
            <input
              ...
              className='outline-none border border-gray-200 rounded-lg pl-8 md:pl-10 pr-1 py-2 md:py-2.5 w-70 md:w-95  md:text-md hover:border-gray-600'
            />
          </div>
        </div>
        ...
        <div className='m-10 border border-gray-200 rounded-md overflow-x-auto'>
          ...
          <div className='min-w-170'>
            <div className='grid grid-cols-5 bg-gray-50 px-10 py-4 font-medium text-gray-600'>
              <p>Category Name</p>
              <p>Icon</p>
              <p>Status</p>
              <p>Products</p>
            ...
            {categories.map((categ) => {
              ...
              return (
                <div key={categ.id}
                  className='grid grid-cols-5 px-10 py-4 border-b border-gray-100 items-center font-medium'
                >
                  <p>{categ.name}</p>
                  <p><IconComponent color={categ.color} /> </p>
                  <p>
                  ...
                  <p className='flex gap-2'>
                    <SquarePen size={20} className='hover:text-blue-600 hover:cursor-pointer' />
                    <Trash size={20} className='hover:text-red-600 hover:cursor-pointer' />
                  </p>
                </div>
              )
            })}
